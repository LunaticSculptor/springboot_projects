...
import com.example.employee_service.model.DTO.EmployeeSalaryDTO;
...
//        Pageable pageable = PageRequest.of(page, size, sort);
    ...
    public Optional<BigDecimal> getEmployeeSalary(Long id) {
        return employeeRepo.findSalaryByEmployeeId(id);
//        EmployeeSalaryDTO employeeSalary = new EmployeeSalaryDTO();
//        Employee employee = employeeRepo.findById(id).orElse(null);
//        BigDecimal salary = employeeRepo.findSalaryByEmployeeId(id).orElse(null);
//        System.out.println(salary);
//        if(employee == null) return employeeSalary;
//        employeeSalary.setSalary(employee.getSalary());
